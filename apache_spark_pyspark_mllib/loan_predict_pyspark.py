...
# Fix invalid values 
df = df.withColumn("Dependents", when(col("Dependents") == "3+", "3").otherwise(col("Dependents")).cast("int"))
...
models = {
    "Random Forest": RandomForestClassifier(featuresCol="features", labelCol="Loan_Status_Indexed", numTrees=100),
    "Naive Bayes": NaiveBayes(featuresCol="features", labelCol="Loan_Status_Indexed"),
    "Decision Tree": DecisionTreeClassifier(featuresCol="features", labelCol="Loan_Status_Indexed", maxDepth=5)
}
